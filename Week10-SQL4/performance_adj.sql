...
GROUP BY
  d.dept_no;
END -- I suspect my if statement is misplaced but I can't find examples of how it should be stated and I'm out of time. can you put an if statement in a set statement?